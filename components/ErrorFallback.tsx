    ...
    <View style={[styles.container, { backgroundColor: C.bg }]}>
      {__DEV__ ? (
        <Pressable
          ...
          style={({ pressed }) => [
            styles.topButton,
            { top: insets.top + 16, backgroundColor: C.bgCard, opacity: pressed ? 0.8 : 1 },
          ]}
        >
      ...
      <View style={styles.content}>
        <Text style={[styles.title, { color: C.textBright }]}>Something went wrong</Text>
        <Text style={[styles.message, { color: C.textMuted }]}>Please reload the app to continue.</Text>
        <Pressable
        ...
        >
          <View style={styles.modalOverlay}>
            <View style={[styles.modalContainer, { backgroundColor: C.bg }]}>
              ...
              >
                <View style={[styles.errorContainer, { backgroundColor: C.bgCard }]}>
